{
  ...
  haUrl = "https://home-assistant.ilma4.home.arpa";
  ...
  # Self-signed *.ilma4.home.arpa cert that Traefik serves on the NAS (certs/wildcard-ec.crt, public,
...
in {
  ...
  config = lib.mkIf cfg.enable (lib.warnIf (!haveCert) ''
    i4.ha-mcp: certs/wildcard-ec.crt is missing — add the *.ilma4.home.arpa cert (see certs/README.md).
