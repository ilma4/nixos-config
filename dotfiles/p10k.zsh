# Generated by Powerlevel10k configuration wizard on 2025-07-26 at 08:21 CEST.
...
# Inactive segment settings remain below as comments; home/zsh.nix strips
# commented lines from the compiled runtime copy.
#
...
#  # home/zsh.nix replaces this with the reftable-capable daemon's absolute path
#  # before compiling the deployed config.
#  typeset -gx GITSTATUS_DAEMON=gitstatusd
